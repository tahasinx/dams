<?php
session_start();
require_once '../LoginController/Partner.php';
$result = '';
...
if (isset($_POST['login'])) {
    ...
    $result = $login->partner_login($_POST);
}
?>
<!DOCTYPE html>
<html>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-5" style="color:white;font-size:20px">
                    <a href="../clients/">CLIENT PORTAL</a>||
                    <a  class="active" href="index.php">PARTNER PORTAL</a>||
                    <a href="../admin/">ADMIN PORTAL</a>
                </div>
                <div class="col-sm-12">
                    <div class="form">
                        <div class="head">PARTNER <?php echo $result ?><br><h3><b>Sign in</b></h3></div>
                        <br/>
