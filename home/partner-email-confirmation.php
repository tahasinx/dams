...
if (isset($_POST['submit'])) {
    $result = $server->partner_email_confirmation($_POST);
}
?>
<!DOCTYPE html>
<html lang="en-US">
                            ...
                            <table>
                                <tr>
                                    <td style="width:200px">
                                        <h4>We have sent a 6 digit code to &nbsp;<span style="color:blue"><?php echo $email = $_SESSION['partner_email']; ?></span>. Please provide the code here. </h4>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
