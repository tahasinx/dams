...
<div id="page-title" class="padding-tb-30px gradient-white">
    <div class="container">
        <table style="border: none">
            <tr>
                <td style="width: 400px"><h1 class="font-weight-300"
                                             style="text-transform: uppercase;margin-left: -20px"><u>Drugs in <?= $_GET['institute_name'] ?></u></h1></td>
                <td><input id="myInput" placeholder="Search ........" style="260px" class="form-control"></td>
                <td><a href="drugsPrescription.php?partner_id=<?= $_GET['partner_id'] ?>" class="btn btn-outline-primary"><i class="fa fa-upload"></i>&nbsp;Order By Prescription</a></td>
            </tr>
        </table>
