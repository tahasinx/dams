...
$data = $server->view_labs();
$branch = $server->lab_branches();
...
<div id="page-title" class="padding-tb-30px gradient-white">
    <div class="container">
        <table style="border: none">
            <tr>
                <td style="width: 250px"><h1 class="font-weight-300" style="text-transform: uppercase;margin-left: -20px"><u>Our Labs</u></h1></td>
                <td>
                    <input id="myInput" placeholder="Search for name,country,city,region." style="width:270px" class="form-control">
                </td>
                <td>
                <td>
                    <a href="location-on-map.php?institute_name=pharmacy in firmgate, Dhaka" onclick="window.open(this.href, 'popUpWindow', 'height=500,width=1000'); return false;" class="btn btn-outline-primary" title="">
                        <i class="fa fa-map-o"></i>&emsp;Labs in my location.
                    </a>
                </td>
                </td>
            </tr>
        ...
        <div class="row">
            ...
            <div class="col-sm-4" >
                        ...
                        <div class="card" style="padding: 3%">
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <a href="tests-by-labs.php?partner_id=<?= $row['partner_id'] ?>&institute_name=<?= $row['institute_name'] ?>" class="btn btn-outline-dark" >
                                            <i class="fa fa-medkit"></i> &emsp; Order Tests
                                        </a>
                                    </td>
                                </tr>
                                <tr>
                ...
                <?php if (isset($_POST['search_branch'])) {
                    $data = $server->labBranch_byID($_POST);
                    while ($row = $data->fetch_assoc()) {
                        ?>
                        <div class="card" style="padding: 3%">
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <a href="tests-by-labs.php?partner_id=<?= $row['partner_id'] ?>&institute_name=<?= $row['institute_name'] ?>" class="btn btn-outline-dark" style="float: right">
                                            <i class="fa fa-medkit"></i> &emsp; Order Tests
                                        </a>
                                    </td>
                                </tr>
