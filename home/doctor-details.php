                    ...
                    <div class="card" style="padding: 3%;margin-bottom: 50px;width: 100%">
                        <table>
                            <tr>
                                ...
                                <td>
                                    <a href="doctor-branches.php?partner_id=<?= $partner_id ?>&doctor_type=<?= $doctor_type ?>&doctor_title=<?= $doctor_title ?>" class="btn btn-outline-primary" title="">
                                        <i class="fa fa-home"></i>&emsp;View Branches
                                    </a>
                                </td>
                            </tr>
                            <tr>
