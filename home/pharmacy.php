...
$data = $server->view_pharmacies();
$branch = $server->view_branches();
    ...
    <div class="container">
        <table style="border: none">
            <tr>
                ...
                <td><input id="myInput" placeholder="Search for name,country,city,region." style="width:270px" class="form-control"></td>
                <td>
                <td>
                    <a href="location-on-map.php?institute_name=pharmacy in firmgate, Dhaka" onclick="window.open(this.href, 'popUpWindow', 'height=500,width=1000'); return false;" class="btn btn-outline-primary" title="">
                        <i class="fa fa-map-o"></i>&emsp;Pharmacies in my location.
                    </a>
                </td>
                </td>
            </tr>
                    ...
                    while ($row = $data->fetch_assoc()) {
                        ...
                        <table>
                            <tr>
                                ...
                                <td>
                                    <a href="drugs-by-pharmacy.php?partner_id=<?= $row['partner_id'] ?>&institute_name=<?= $row['institute_name'] ?>" class="btn btn-outline-dark" >
