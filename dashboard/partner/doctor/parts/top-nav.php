<div class="header" style="background-color: black">
    ...
    <ul class="nav user-menu float-right">
        ...
        <li class="nav-item dropdown d-none d-sm-block">
            <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown"><i class="fa fa-bell-o"></i> <span class="badge badge-pill bg-danger float-right">
                    <div id="notification_count"><?php echo $server->total_notification(); ?></div>
                </span></a>
                                    ...
                                    <a href="message-inbox.php">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <p class="noti-details"><span class="noti-title"></span>&nbsp;<span class="noti-title"><?php echo $row2['notification_about'] ?></span>
                                                </p>
                                                <p class="noti-time"><span class="notification-time"><?php echo $row2['notification_time'] ?></span>
                                                </p>
                                            </div>
                                        </div>
                                    </a>
        ...
        <li class="nav-item dropdown has-arrow">
            <a href="#" class="dropdown-toggle nav-link user-link" data-toggle="dropdown">
                <span class="user-img">
                    <img class="rounded-circle" style="height: 40px;width: 40px" src="<?php echo $row['institute_logo'] ?>" onerror="this.onerror=null; this.src='assets/img/user.jpg'" width="24" alt="">
