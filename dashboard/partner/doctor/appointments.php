                ...
                <div class="content">
                    <div class="row">
                        ...
                        <div class = "col-sm-4 col-6 text-right m-b-30">
                            <a href="appointments-upcoming.php" class="btn btn-primary btn-rounded float-right"><i class="fa fa-pencil"></i>Upcomings</a>
                        </div>
                    </div>
                    <div class="row">
                                        ...
                                        while ($row = $data->fetch_assoc()) {
                                            ...
                                            <center>
                                                <form method="POST" action="">
                                                    <a href="#modal<?= $m++ ?>" class="btn btn-outline-primary"><i class="fa fa-user"></i></a>
