...
$drugs = $server->cancelled_drugOrders();
$prescriptions = $server->cancelled_prescriptions();
                        ...
                        <div class="card-header">
                            <h4>Orders For Drug
                                <a href="#" class="btn btn-outline-dark float-right">Total Orders:
                                    <span style="color: orangered"><?= $server->totalCancelled_drugOrders() ?></span>
                                </a>
                            </h4>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4>Orders By Prescription
                                <a href="#" class="btn btn-outline-dark float-right">Total Orders:
                                    <span style="color: orangered"><?= $server->totalCancelled_prescriptions() ?></span>
                                </a>
                            </h4>
                        </div>
                        <div class="card-body p-0">
