...
$drugs = $server->ordersFor_drugs();
$prescriptions = $server->ordersBy_prescriptions();
...
if (isset($_POST['processing'])) {
    ...
    if($_POST['x'] == 0){
        ...
        $server->drugOrder_processing($_POST);

    }elseif ($_POST['x'] == 1){

        $server->prescription_processing($_POST);
...
<div class="main-wrapper">
    ...
    <div class="page-wrapper">
        <div class="content">
            <div class="row">
                <div class="col-sm-8">
                    <h4 class="page-title text-purple">
                        <u>Pending Orders</u>
                    </h4>
                </div>
                <div class="col-sm-4">
                        ...
                        <div class="card-header">
                            <h4>Orders For Drug
                                <a href="#" class="btn btn-outline-dark float-right">Total Orders:
                                    <span style="color: orangered"><?= $server->totalOrders_forDrugs() ?></span>
                                </a>
                            </h4>
                        </div>
                                                    ...
                                                    <div class="col-lg-10 offset-lg-1">
                                                        ...
                                                        <center>
                                                            <form method="POST" action="">
                                                                ...
                                                                <button type="submit" name="processing" class="btn btn-outline-primary" style="cursor: pointer;width: 160px">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4>Orders By Prescription
                                <a href="#" class="btn btn-outline-dark float-right">Total Orders:
                                    <span style="color: orangered"><?= $server->totalOrders_byPrescriptions() ?></span>
                                </a>
                            </h4>
                        </div>
                        <div class="card-body p-0">
