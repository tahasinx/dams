...
$drugs = $server->delivered_drugOrders();
$prescriptions = $server->delivered_prescriptions();
                        ...
                        <div class="card-header">
                            <h4>Orders For Drug
                                <a href="#" class="btn btn-outline-dark float-right">Total Orders:
                                    <span style="color: orangered"><?= $server->totalDelivered_drugOrders() ?></span>
                                </a>
                            </h4>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4>Orders By Prescription
                                <a href="#" class="btn btn-outline-dark float-right">Total Orders:
                                    <span style="color: orangered"><?= $server->totalDelivered_prescriptions() ?></span>
                                </a>
                            </h4>
                        </div>
                        <div class="card-body p-0">
