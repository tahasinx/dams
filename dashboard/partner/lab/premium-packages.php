                    ...
                    <div id="price" class="row">
                        ...
                        <div class="col-sm-3 plan">
                            <div class="plan-inner">
                                ...
                                <div class="button">
                                    <?php if ($account_status == 0 || $location_status == 0) { ?>
                                        <a href="#modal1">Order Now</a>
                                    <?php } else { ?>
                                        <form method="POST">
                                            <button name="ok" class="btn btn-dark" type="submit"> SELECT </button>
                                        </form>
                                    <?php } ?>
                                </div>
                            </div>
                        ...
                        <?php } elseif ($account_status <> 0 && $location_status == 0) { ?>
                            <!--modal-->
                            <div class="awesome-modal" id="modal1"><a class="close-icon" href="#close"></a>
                                <center>
                                    <h3 class="modal-title">You need to verify your location first.</h3>
                                    <br>
                                    <a href="verify-location.php" class="btn btn-primary">Verify Location</a>
                                </center>
                            </div>
                        <?php } elseif ($account_status == 0 && $location_status == 0) { ?>
                            <!--modal-->
                            <div class="awesome-modal" id="modal1"><a class="close-icon" href="#close"></a>
                                <center>
                                    <h3 class="modal-title">Your account and location is not verified.</h3>
                                    <br>
                                    <a href="verify-account.php" class="btn btn-success">Verify Account</a>
                                    &emsp;||&emsp;
                                    <a href="verify-location.php" class="btn btn-primary">Verify Location</a>
