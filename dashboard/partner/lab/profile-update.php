    ...
    <?php while ($row = $result->fetch_assoc()) { ?>
        ...
        <div class="page-wrapper">
            <div class="content">
                ...
                <div class="row">
                    <div class="col-sm-8">
                        <h4 class="page-title"><u>Edit Profile</u><?php echo $updateError; ?></h4>
                    </div>
                    <div class="col-sm-4">
                        <a href="profile-details.php" class="btn btn-primary btn-rounded float-right"><i
                                    class="fa fa-file"></i>&nbsp;Profile</a>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="profile-img-wrap">
                                    <img class="inline-block" src="<?php echo $row['institute_logo'] ?>"
                                         onerror="this.onerror=null; this.src='assets/img/hospital.png'" id="output">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group form-focus">
                                                <label class="focus-label">Institute Name<span
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group form-focus">
                                                <label class="focus-label">Institute Type<span
                                                            class="text-danger">*</span></label>
                                                <input type="text" class="form-control floating" name="institute_type"
                                                       value="Pharmacy" readonly required>
                                            </div>
                                        </div>
