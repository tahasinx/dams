...
$pharmacies = $server->view_pharmacies();
?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="content">
            <div class="row">
                <div class="col-sm-7 col-6">
                    <h4 class="page-title"><u>Partners:</u> <span style="color:orangered"> Pharmacies</span></h4>
                </div>
            </div>
            <div class="row">
                        ...
                        <div class="card-header">
                            ...
                            <a href="" class="btn btn-outline-dark float-right">
                                <span style="color:orangered ">
                                    Total Pharmacies: <?= $server->total_pharmacies() ?>
                                </span>
                            </a>
                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table mb-0">
                                    ...
                                    if ($pharmacies->num_rows > 0) {
                                        while ($data = $pharmacies->fetch_assoc()) {
                                            ?>
