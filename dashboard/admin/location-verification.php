                ...
                <div class="content">
                    <div class="row">
                        <div class="col-sm-6 col-3">
                            <h4 class="page-title"><u>Location Verification</u></h4>
                        </div>
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title d-inline-block">Total Requests[<span style="color:red"><?php echo $server->total_location_requests() ?></span>]</h4> 
                                </div>
