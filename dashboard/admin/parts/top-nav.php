                ...
                <div class="drop-scroll" id="notifications">
                    <ul class="notification-list">
                        ...
                        while ($row2 = $notifications->fetch_assoc()) { ?>
                            ...
                            <li class="notification-message" style="<?php if($row2['is_seen'] == 0){ echo 'background-color: #9ba1a8';}?>" >
                                <a href="message-inbox.php">
                                    ...
                                    <span class="avatar">
                                        ...
                                        <div class="media-body">
                                            <p class="noti-details"><span class="noti-title"></span>&nbsp;<span class="noti-title"><?php echo $row2['notification_about'] ?></span></p>
                            ...
                            <?php if ($row2['notification_type'] === 'location') { ?>
                                <li class="notification-message" style="<?php if($row2['is_seen'] == 0){ echo 'background-color: #9ba1a8';}?>" >
                                    <a href="location-verification.php">
                                        <div class="media">
                                    <span class="avatar">
                                        <img alt="Admin" src="assets/img/user.jpg" class="img-fluid">
                                    </span>
